...
typedef int ImGuiTreeSpriteFlags;   // enum ImGuiTreeSpriteFlags_
...
struct ImGuiContext
{
    ...
    // Storage for SetNexWindow** and SetNextTreeSprite*** functions
    ...
    bool                    SetNextTreeSpriteOpenVal;
    ImGuiSetCond            SetNextTreeSpriteOpenCond;
    ...
    ImGuiContext()
    {
        ...
        SetNextTreeSpriteOpenVal = false;
        SetNextTreeSpriteOpenCond = 0;
...
namespace ImGui
{
    ...
    IMGUI_API bool          TreeSpriteBehavior(ImGuiID id, ImGuiTreeSpriteFlags flags, const char* label, const char* label_end = NULL);
    IMGUI_API bool          TreeSpriteBehaviorIsOpen(ImGuiID id, ImGuiTreeSpriteFlags flags = 0);                     // Consume previous SetNextTreeSpriteOpened() data, if any. May return true when logging
